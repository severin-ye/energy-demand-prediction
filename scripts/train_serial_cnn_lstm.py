...
# 创建输出目录
output_dir = "outputs/models/serial_cnn_lstm"
os.makedirs(output_dir, exist_ok=True)

print("=" * 80)
print("训练串行CNN-LSTM模型（Baseline）")
print("=" * 80)
...
# 保存配置和结果
results = {
    "model_name": "Serial CNN-LSTM (Baseline)",
    ...
    "model_info": {
        ...
        "architecture": "Serial (CNN → LSTM → Dense)"
    },
    "training": {
