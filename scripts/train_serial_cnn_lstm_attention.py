...
from src.models.baseline_models import SerialCNNLSTMAttention
...
# 创建输出目录
output_dir = "outputs/models/serial_cnn_lstm_attention"
os.makedirs(output_dir, exist_ok=True)

print("=" * 80)
print("训练串行CNN-LSTM-Attention模型")
print("=" * 80)
...
# 4. 构建并训练模型
print("\n[4/6] 构建并训练串行CNN-LSTM-Attention模型...")
...
# 保存配置和结果
results = {
    "model_name": "Serial CNN-LSTM-Attention",
    ...
    "model_info": {
        ...
        "architecture": "Serial (CNN → LSTM-Attention → Dense)"
    },
    "training": {
